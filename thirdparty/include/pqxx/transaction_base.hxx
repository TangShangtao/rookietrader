...
#include "internal/concat.hxx"
#include "internal/encoding_group.hxx"
#include "internal/stream_query.hxx"
...
public:
  ...
  {
#include "internal/ignore-deprecated-pre.hxx"
    return conn().unesc_raw(text);
#include "internal/ignore-deprecated-post.hxx"
  }
...
#include "internal/stream_query_impl.hxx"
#endif
