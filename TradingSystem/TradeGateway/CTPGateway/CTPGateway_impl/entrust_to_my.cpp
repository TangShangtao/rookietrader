...
Entrust* CTPGateway::entrust_to_my(CThostFtdcInputOrderField* entrustField)
{
    ...
    if (contract == nullptr) 
    {
        Logger::error("CTPGateway::entrust_to_my: contract not found: {} {}", entrustField->InstrumentID, entrustField->ExchangeID);
        return nullptr;
    }
    ...
    parse_entrustID(pret->get_entrustID(), m_uFrontID, m_uSessionID, strtoul(entrustField->OrderRef, nullptr, 10));
